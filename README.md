...
I have created several simple [notebooks](https://github.com/feifeiwww/20220831_Databricks_Simple_Demo/tree/main/notebooks) to help new users understand Databricks' use cases. A lot of the examples are based on the diabetes_modified.csv file under raw_data  folder. Users can create a database on Databricks by using ```%sql create database feifei_wang ``` inside of a notebook (for example notebook1), and use UI to upload this csv file to the database. Refer to this graph for create table button: <img width="991" alt="image" src="https://user-images.githubusercontent.com/109642474/187309635-8a3dfb57-c266-4a71-9cff-0b0c69312db8.png">
